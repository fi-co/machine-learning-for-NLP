...
# -*- coding: utf-8 -*-
"""
Created on Sat Jun 29 11:39:33 2024
...
#t his function learns parmeters for the neural network and returns the model
...
def build_model(nn_hdim, num_passes=20000, print_loss=False):
    ...
    for i in range(0, num_passes):
        ...
        delta2 = delta3.dot(W2.T) * (a1 * (1 - a1))  # Gradient for sigmoid
