...
# -*- coding: utf-8 -*-
"""
Created on Tue Jun  4 14:07:55 2024
...
with timed_block("Entire Script"):
    ...
    plt.title('Dataset with increased noise')
    plt.show()
    ...
    def build_model (nn_hdim, num_passes = 20000, print_loss = False, batch_size = 128):
    ...
    plot_decision_boundary(lambda x: predict(model, x))
    plt.title("Decision boundary (hl=3, epochs=20k, minibatch GD)")
